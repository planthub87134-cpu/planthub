    ...
    <div className="page-container" style={{ padding: 'var(--space-6) 0' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 var(--space-4)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-6)' }}>
          <h1 style={{ fontSize: 'var(--text-3xl)', margin: 0 }}>Customer Support</h1>
          
          <div style={{ display: 'flex', gap: '8px', background: 'white', padding: '4px', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)' }}>
            <button 
            ...
            <button 
              ...
              className={`btn btn-sm ${activeTab === 'crm' ? 'btn-primary' : 'btn-ghost'}`}
              style={{ borderRadius: 'var(--radius-md)' }}
            >
              CRM & Doctor (Staff View)
            </button>
          </div>
        </div>
        ...
        {activeTab === 'tickets' ? (
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 'var(--space-6)' }}>
            ...
            <div style={{ backgroundColor: 'white', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)', overflow: 'hidden' }}>
              <div style={{ padding: 'var(--space-4)', borderBottom: '1px solid var(--border-light)', backgroundColor: 'var(--bg-subtle)' }}>
                <h2 style={{ fontSize: 'var(--text-lg)', fontWeight: 'var(--font-bold)' }}>My Tickets</h2>
              </div>
          ...
          <div style={{ height: '750px', backgroundColor: 'white', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-light)', padding: 'var(--space-4)' }}>
            <CRMDashboard />
          </div>
        )}
      </div>
