        ...
        <div className="container">
          <div className="hero-content animate-slide-up">
            ...
            <div className="hero-actions">
              ...
              <Link to="/contact" className="btn btn-secondary btn-lg" id="hero-contact">
                Learn More
              </Link>
            </div>
            <div className="hero-stats">
              ...
              <div className="stagger-item animate-slide-up delay-4">
                <div className="hero-stat-value">50+</div>
                <div className="hero-stat-label">Plant Varieties</div>
              </div>
            </div>
          </div>
